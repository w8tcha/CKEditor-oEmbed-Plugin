CKEDITOR.plugins.setLang('oembed',
    'bg',
    {
        ...
        pasteUrl: "Вмъкнете URL (съкратени URL също се поддържат) от поддържаните сайтове (напр. YouTube, Flickr, Qik, Vimeo, Hulu, Viddler, MyOpera, и т.н.).",
        invalidUrl: "Моля, посочете валиден URL.",
        noEmbedCode: "Няма намерен код за вграждане или сайтът не се поддържа.",
        embedTitle: "Заглавие (или етикет на област) <span class='oembed-required'>[Задължително]</span>:",
        ...
        noVimeo: "Притежателят на този видеоклип е задал ограничения на домейна и няма да можете да го вградите във Вашия сайт.",
        Error: "Не можа да бъде намерено медийно съдържание, опитайте с различен URL.",
        titleError: "Заглавието на медията е задължително, за да се спазят стандартите за достъпност."
    });
