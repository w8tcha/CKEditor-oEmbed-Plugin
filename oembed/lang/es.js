CKEDITOR.plugins.setLang('oembed',
    'es',
    {
        ...
        pasteUrl: "Insertar una URL (también se admiten las URLs acortadas) de alguna de las páginas compatibles (p. ej., YouTube, Flickr, Qik, Vimeo, Hulu, Viddler, MyOpera, etc.).",
        invalidUrl: "Proporcione una URL válida.",
        noEmbedCode: "Ningún código de inserción encontrado, o bien la página no es compatible.",
        embedTitle: "Título (o etiqueta aria) <span class='oembed-required'>[Requerido]</span>:",
        url: "URL <span class='oembed-required'>[Requerido]</span>:",
        width: "Anchura:",
        height: "Altura:",
        ...
        noVimeo: "El propietario de este vídeo ha establecido restricciones de dominio, por lo que usted no puede integrarlo en su página web.",
        Error: "No ha sido posible recuperar el contenido multimedia, intente introducir una URL diferente.",
        titleError: "El título de los medios debe cumplir las normas de accesibilidad."
    });
