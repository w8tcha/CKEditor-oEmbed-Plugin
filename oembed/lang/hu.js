CKEDITOR.plugins.setLang('oembed',
    'hu',
    {
        ...
        pasteUrl: "URL beillesztése (a rövidítített URL-ek is támogatottak) az egyik támogatott oldalról (pl. Youtube, Flickr, Qik, Hulu, Viddler, MyOpera stb.).",
        invalidUrl: "Kérjük, érvényes URL-t adjon meg.",
        noEmbedCode: "Nem található beágyazott kód, vagy az oldal nem támogatott.",
        embedTitle: "Cím (vagy aria-label) <span class='oembed-required'>[Required]</span>:",
        ...
        noVimeo: "A videó tulajdonosa domainkorlátozásokat állított be, így Ön nem tudja beágyazni a weboldalára.",
        Error: "A médiatartalmat nem lehetett lehívni, kérjük, próbáljon egy másik URL-t.",
        titleError: "A média címének meg kell felelnie a hozzáférési szabványoknak."
    });
