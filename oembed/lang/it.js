CKEDITOR.plugins.setLang('oembed',
    'it',
    {
        ...
        pasteUrl: "Incolla un URL (anche gli URL abbreviati sono supportati) da uno dei siti supportati (per es. YouTube, Flickr, Qik, Vimeo, Hulu, Viddler, MyOpera, ecc.).",
        invalidUrl: "Si prega di inserire un URL valido.",
        noEmbedCode: "Nessun codice integrato trovato o il sito non è supportato.",
        embedTitle: "Tirolo (o etichetta-aria) <span class='oembed-required'>[Required]</span>:",
        ...
        noVimeo: "Il proprietario di questo video ha impostato delle restrizioni di dominio per questo non è possibile integrarlo nella pagina web.",
        Error: "Contenuto Media non recuperato, si prega di provare con un URL differente.",
        titleError: "Titolo Media richiesto per rispettare gli standard d'accesso."
    });
