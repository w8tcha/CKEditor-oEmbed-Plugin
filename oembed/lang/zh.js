CKEDITOR.plugins.setLang('oembed',
    'zh',
    {
        title: "嵌入媒體 (照片, 影片, 音樂 )",
        button: "嵌入外部媒體",
        pasteUrl: "貼上網址 (短網址也可以) 支援以下站點 (e.g. YouTube, Flickr, Qik, Vimeo, Hulu, Viddler, MyOpera, etc.).",
        invalidUrl: "請提供合法網址",
        noEmbedCode: "無法產生內嵌語法或者不支援",
        embedTitle: "標題 (or aria-label) <span class='oembed-required'>[Required]</span>:",
